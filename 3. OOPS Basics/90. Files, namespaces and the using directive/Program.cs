...
/// While coping and pasting the class manually, you did not remove the namespace and paste the code in the namespace
...
/// If we import the main namespace then all the subnamespaces will be imported too. But that is not the case.
/// You have to show the with the help of using directives and concatinate the namespaces using the . 
